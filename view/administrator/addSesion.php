        ...
        <section id="content">
            ...
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="index.php?c=sesion&a=addSesion">
                        ...
                        <center>
                            <div>
                                ...
                                <input class="form-control" name="dateSesion" style="width:20%;" type="date">
                            </div>
                        </center>
                        <br>
                        ...
                        <center>
                            <div>
                                ...
                                <input class="form-control" name="dateLimite" style="width:20%;" type="date">
                            </div>
                        </center>
                        <br>
                        ...
                        <input type="submit" value="Añadir" class="btn btn-primary" style="background:rgb(226, 3, 26); border:none; color:white" />
